  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 font-sans">
      <div className="max-w-5xl mx-auto bg-white rounded-3xl shadow-xl overflow-hidden flex flex-col md:flex-row transition-all duration-300 hover:shadow-2xl">
        ...
        <div className="md:w-1/3 bg-gradient-to-br from-slate-700 to-slate-900 p-10 flex flex-col items-center justify-center text-white relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <p className="text-slate-300 mt-1 font-light text-sm">{profile.email}</p>
        ...
        <div className="md:w-2/3 p-10 md:p-12">
          <div className="flex justify-between items-center mb-8">
            ...
            <span className="text-sm text-gray-400 italic">Nhà cung cấp (Supplier)</span>
          </div>
          ...
          <form onSubmit={handleSave} className="space-y-6">
            ...
            <div className="group">
              ...
              <div className="relative">
                <input 
                  type="text" 
                  className="w-full pl-4 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-slate-500 focus:border-transparent transition-all outline-none text-gray-800 font-medium placeholder-gray-400"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input 
                  type="text" 
                  className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-slate-500 focus:border-transparent transition-all outline-none text-gray-800"
            ...
            <div>
              ...
              <textarea 
                rows={2}
                className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-slate-500 focus:border-transparent transition-all outline-none text-gray-800 resize-none"
            ...
            <div className="pt-6 border-t border-gray-100 mt-8">
              <button 
                type="submit" 
                disabled={saving}
                className="w-full md:w-auto px-8 py-3.5 bg-gradient-to-r from-slate-700 to-slate-900 text-white font-bold rounded-xl shadow-lg hover:shadow-slate-500/30 hover:translate-y-[-1px] active:scale-[0.98] transition-all disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {saving ? (
                  <>
